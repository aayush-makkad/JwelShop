...
<div class="card">
    ...
    <div class="card-body px-lg-5 pt-0" id='DivIdToPrint'>
        ...
        <!-- Form -->
        <form class="text-center" style="color: #757575;" action="process-repair.php?" id="myform" >
        	<input type="hidden" name="id" value="<?php echo $id; ?>">
            <div class="form-row">
                <div class="col">
                    <!-- First name -->
                    <div class="md-form">
                        <input type="text" id="materialRegisterFormFirstName" class="form-control" name="name" value=<?php echo $first_name; ?> readonly>
             ...
             <div class="md-form mt-0">
                <input type="textarea" id="materialRegisterFormEmail" class="form-control" name="explain" value=<?php echo $explain;?> readonly>
                <label for="materialRegisterFormEmail">Explanation</label>
            </div>
